...
\add[inline]{Paragraph leading into the CNN classifier part}
...
The aim of this project is therefore to investigate whether EEG and other low-cost biosensors can be used to study the relationship between device activity and brain activity. This will be done in part by trying to train a device activity classifier from EEG data. % This will be useful to future BCI applications where a command might be specific to a particular context.
...
\begin{figure}[h]
\centering
\includegraphics[width=8cm]{gcm.png}
