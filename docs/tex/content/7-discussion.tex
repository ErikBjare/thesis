...
With respect to RQ1, we found that we do improve upon the best classifier performance by Fucci et al (in their EEG-only configuration). However, our sample group is a lot smaller, and more homogenous. We were not able to beat the performance achieved by Floyd et al.\ using fMRI\@.
...
\todo[inline]{More discussion of results}
