...
Our results are impacted by our cherry-picked subject set for our final analysis. Issues with signal quality and limited data (due to spurious device disconnects during experiments) ultimately led to exclusion of several subjects. 

Our findings show that the Riemannian methods used in this paper are better at distinguishing between the code and prose tasks than the bandpower-features approach used by Fucci et al.
