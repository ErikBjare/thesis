...
\change[inline]{Move this paragraph elsewhere}
...
\add[inline]{Markus: Jag hade avslutat detta stycke med en mening med att spoila resultatet. I akademiska texter skriver man samma sak många gånger, med lite olika vinkel och touch. Intron blir en teaser för läsare - ska locka till vidare läsning.}

\add[inline]{Briefly describe results}
