...
\section{Devices}
    ...
    We experimented with several devices but eventually settled on the Muse S for both our experiments. The motivation for choosing the Muse S was mainly due to comfort and ease of use. 
...
\end{enumerate}
    ...
    \subsection{Collection of device activity data}\label{section:collect-usage}
        ...
        All device activity is collected using the automated time tracker ActivityWatch~\cite{bjareholt_activitywatch_2020}.
...
% textidote: ignore end
    ...
    \subsection{Performance scoring}\label{section:scoring}
        ...
        Previous studies have used \acrfull{bac} scoring to evaluate model performance. To be able to compare results to previous studies, we do the same. 
