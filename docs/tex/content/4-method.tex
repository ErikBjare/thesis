...
\end{minted}
        ...
        \subsubsection*{During code vs prose comprehension task}
            ...
            We note that Fucci et al.~modified the prose comprehension images from the original review-like task to become more comprehension-like, arguably better suited for the task. However, due to the modified images being in Italian, we have used the original images by Floyd et al.
...
\todo[inline]{Decide on final classes for organic use}
...
\section{Analysis}
    ...
    \subsection{Feature engineering}
        ...
        \subsubsection{Bandpower}
            ...
            \todo[inline]{Markus: gjorde vi eller skulle vi kunna göra i future work?}
    ...
    \subsection{Cross Validation}
        ...
        \add[inline]{Markus: Behöver utvecklas. Figur + text.}
