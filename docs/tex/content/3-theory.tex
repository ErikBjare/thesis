...
\section{Electroencephalography (EEG)}\label{eeg-theory}
    ...
    \begin{figure}
        ...
        \caption{Example of an aggregated epoch-averaged ERP trials from an N170 experiment where the subject was shown either a face or a house. The vertical line marks the beginning of the epoch. The two stereotyped responses can be seen in \textcolor{red}{\textbf{red}} and \textcolor{green}{\textbf{green}}, with the difference seen in black.}\label{figure:n170}
        \source{eeg-notebooks \href{https://neurotechx.github.io/eeg-notebooks/auto_examples/visual_n170/01r__n170_viz.html}{experiment gallery}}
    \end{figure}
