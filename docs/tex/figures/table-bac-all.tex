\begin{table}[h]
    ...
    \begin{tabular}{lcccc}
        ...
        \bottomrule
    \end{tabular}
    \caption{The \glsxtrlong{bac} for each \gls{loro} subject-fold. Excluding subjects \#3 and \#4 due to poor signal quality. Subject \#2 does not exist due to an off-by-one mistake during experiment setup (what should have been subject \#2 became \#3).}\label{table:bac-all}
\end{table}
