...
\subsection{Automated time trackers}
    ...
    \subsubsection{ActivityWatch}
        ...
        \todo{Update screenshot to v0.11}
        ...
        ActivityWatch as a project was started in 2016 by the author of this thesis, with his brother Johan joining development soon after. It has since become a popular open source alternative to other time tracking software. It has received numerous contributions from users \todo{link to contributors page on website} and is approaching 100,000 downloads \todo{link to stats page}.

        \todo{What more could I add about ActivityWatch? There should be relevant stuff in the docs, and in the slides I made way back.}
...
\subsection{EEG and low-cost biosensors/functional brain imaging}
    ...
    \add{Seperate sections for applications in BCIs vs neuroscience}
...
\section{Theory}
    ...
    \subsection{Electroencelography (EEG)}
...
\section{Method}
    ...
    \subsection{Collection of EEG data}
        ...
        For both conditions, code from the open source eeg-notebooks~\cite{noauthor_neurotechxeeg-notebooks_2020} was adapted to record the raw EEG stream into a CSV file. For the Muse S, muse-lsl~\cite{muselsl_2020} was used as the underlying software to handle the connection (which uses Lab Streaming Layer). For the OpenBCI and Neurosity devices, brainflow~\cite{noauthor_brainflow-devbrainflow_2020} was used to handle the connection.
        ...
        \subsubsection{Devices}
            ...
            \begin{center}
                \begin{tabular}{ c|c|c }
                 Device & Channels & Sampling rate & Comfort \\
                 \hline
                 Muse S
                    & 4
                    & 250Hz
                 ...
                 Neurosity Notion DK1
                    & 8
                    & 250Hz?
                    & Medium \\
                  % preordered, arrives in late spring
                  Neurosity Notion 3 ("Crown")
                    & 8?
                    & 250Hz?
                    & High? \\
                \end{tabular}
    ...
    \subsection{Analysis}
        ...
        \subsubsection{Data cleaning}
            ...
            \todo{List how many epochs are rejected by each cleaning step}
...
As part of the work on this thesis I've contributed several improvements to the open source projects used, including muse-lsl, moabb, eeg-notebooks, and pyRiemann. \todo[inline]{list with links to PRs?}
