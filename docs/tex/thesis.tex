...
\def\mytitleen{Classifying brain activity using low-cost biosensors and automated time tracking}
\def\mytitlesv{Klassificering av hjärnaktivitet med hjälp av elektroencephalografi och automatiserad tidsspårning}
...
\else
    ...
    \examiner{Elizabeth Bjarnarson, \href{mailto:elizabeth@cs.lth.se}{\texttt{elizabeth@cs.lth.se}}}
    ...
    \keywords{electroencephalography, time tracking, code comprehension, productivity, MSc}
\fi
