...
\section{Methods}
    ...
    \subsection{Collection of EEG data}
        ...
        \subsubsection{During organic device use}
            ...
            For the organic device use conditions, we primarily used the Muse S EEG headband which features 4 channels with electrodes placed at TP9, AF7, AF8, and TP10 (1020-system). Reasons for choosing the Muse S were mainly due to the considerably improved comfort during long recordings, compared to the other dry-electrode headsets available.
    ...
    \subsection{Analysis}
        ...
        For classification and analysis, we used common open source Python libraries like numpy, pandas, scikit-learn~\cite{scikit-learn}. Specifically to EEG data, we also used MNE~\cite{noauthor_mne-toolsmne-python_2020}, pyriemann~\cite{alexandre_barachant_2020_3715511}, YASA~\cite{raphael_vallat_raphaelvallatyasa_2020}.

        \subsubsection{Feature engineering}

            Bandpower features are simple and commonly used in EEG research for basic tasks, we utilized the bankpower function provided by YASA\@.
...
\begin{itemize}
 ...
 \item Everyone who's contributed to the open source tools used.
